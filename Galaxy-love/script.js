...
const defaultHeartImages = Array.from({ length: 40 }, (_, i) => `images/img${i + 1}.jpeg`);
...
const ringTexts = [
  ...
  "♡Happy Anniversary 3 Months♡",//untuk deskripsi planet layer 3
  "10/10/2026",//untuk deskripsi planet layer 4
...
function createHintText() {
  ...
  const context = canvas.getContext('2d');
  const fontSize = 50;
  const text = 'Happy Anniversary for 3 MONTHS!';
